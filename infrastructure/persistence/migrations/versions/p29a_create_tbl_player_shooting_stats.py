"""Create tbl_player_shooting_stats in sch_football schema.

Stores per-season shooting statistics (shots, goals, xG proxies, etc.)
...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column(
            "shots", sa.SmallInteger(), nullable=False, server_default=sa.text("0")
        ),
        sa.Column(
            "shots_on_target",
            sa.SmallInteger(),
        ...
        sa.PrimaryKeyConstraint(
            ...
            "fk_team",
            "fk_comp",
            name="pk_tbl_player_shooting_stats",
        ),
        sa.ForeignKeyConstraint(
            ["player_id"],
            ["sch_shared.tbl_players.player_id"],
            name="fk_player_shooting_stats_player_id",
            ondelete="CASCADE",
        ),
        sa.ForeignKeyConstraint(
            ["fk_team"],
            ["sch_shared.tbl_teams.team_id"],
            name="fk_player_shooting_stats_fk_team",
            ondelete="RESTRICT",
        ),
        sa.ForeignKeyConstraint(
            ["fk_country"],
            ["sch_shared.tbl_countries.country_id"],
            name="fk_player_shooting_stats_fk_country",
            ondelete="SET NULL",
        ),
        sa.ForeignKeyConstraint(
            ["fk_comp"],
            ["sch_shared.tbl_competition.comp_id"],
            name="fk_player_shooting_stats_fk_comp",
            ondelete="RESTRICT",
        ),
        schema="sch_football",
    )
    ...
    op.create_index(
        "ix_tbl_player_shooting_stats_season",
        "tbl_player_shooting_stats",
        ["season"],
        schema="sch_football",
    )
    op.create_index(
        "ix_tbl_player_shooting_stats_fk_team",
        "tbl_player_shooting_stats",
        ["fk_team"],
        schema="sch_football",
    )
    op.create_index(
        "ix_tbl_player_shooting_stats_fk_comp",
        "tbl_player_shooting_stats",
        ["fk_comp"],
        schema="sch_football",
    )
...
def downgrade() -> None:
    op.drop_index(
        "ix_tbl_player_shooting_stats_fk_comp",
        table_name="tbl_player_shooting_stats",
        schema="sch_football",
    )
    op.drop_index(
        "ix_tbl_player_shooting_stats_fk_team",
    ...
    op.drop_table("tbl_player_shooting_stats", schema="sch_football")
