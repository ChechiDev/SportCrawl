...
class Player(Base):
    ...
    positions and queue refs target player_id directly.
    """
    ...
    career_end: Mapped[int | None] = mapped_column(SmallInteger, nullable=True)
    fk_country_team: Mapped[str | None] = mapped_column(
        String(10),
        ForeignKey(
    ...
    __table_args__ = (
        Index("ix_players_fk_country_team", "fk_country_team"),
        {"schema": "sch_shared"},
    )
