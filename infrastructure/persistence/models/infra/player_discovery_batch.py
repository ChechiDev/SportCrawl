"""ORM model for player_discovery_batch in sch_fbref_infra schema."""
...
class PlayerDiscoveryBatch(FootballBase):
    """ORM model for sch_fbref_infra.player_discovery_batch.
    ...
    __table_args__ = ({"schema": "sch_fbref_infra"},)
